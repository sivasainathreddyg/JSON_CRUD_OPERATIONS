		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Demo App",
									"targetURL": "#comdemoproject3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoproject3-display": {
								"semanticObject": "comdemoproject3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.project3",
									"url": sap.ui.require.toUrl("com/demo/project3")
								}
							}
						}
					}
